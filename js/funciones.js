function consultar() {
    ...
    $.ajax(
             {
                url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike',
                type         : 'GET',
                dataType     : 'json',
...
function consultarClient() {
    ...
    $.ajax(
             {
                url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client',
                type         : 'GET',
                dataType     : 'json',
...
function consultarMessage() {
    ...
    $.ajax(
             {
                url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message',
                type         : 'GET',
                dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike/' + id ,
                    type         : 'GET',
                    dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + id ,
                    type         : 'GET',
                    dataType     : 'json',
    ...
    $.ajax (
                {
                    ...
                    url          : 'https://g446a67a49d0026-db202110032149.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message/' + id ,
                    type         : 'GET',
                    dataType     : 'json',
